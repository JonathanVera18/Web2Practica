    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, prisma.serie.create({
                        data: {
                ...
                case 1:
                    ...
                    _a.sent();
                    // Agregar registros a Personaje
                    return [4 /*yield*/, prisma.personaje.create({
                            data: {
                                // Asegúrate de proporcionar todos los campos requeridos aquí
                                nombre: "Homero",
                                anosExperiencia: 5,
                ...
                case 2:
                    ...
                    _a.sent();
                    // Agregar registros a Asignacion
                    return [4 /*yield*/, prisma.asignacion.create({
                            data: {
                                // Asegúrate de proporcionar todos los campos requeridos aquí
                                papel: "Padre",
                                tipoPapel: "Principal",
...
function eliminar(id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.asignacion.update({
                        where: { id: id },
                        data: { estado: false },
                    })];
                case 1:
